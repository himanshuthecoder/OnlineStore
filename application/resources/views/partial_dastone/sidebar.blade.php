...
<div class="left-sidenav">
    ...
    <div class="brand">
        <a href="index.html" class="logo">
            <span>
                <img src="dastone/images/logo-sm.png" alt="logo-small" class="logo-sm">
            </span>
            <span>
                <img src="dastone/images/logo.png" alt="logo-large" class="logo-lg logo-light">
                <img src="dastone/images/logo-dark.png" alt="logo-large" class="logo-lg logo-dark">
            </span>
        </a>
    </div>
    <!--end logo-->
